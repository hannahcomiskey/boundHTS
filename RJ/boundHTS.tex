...
\tightlist
\item
  Predictive mean estimates for the \textbf{top-level series} (\texttt{A})
\item
  Predictive mean estimates for the \textbf{bottom-level series} (\texttt{AA}, \texttt{AB}, \texttt{BA}, \texttt{BB})
\item
...
To reconcile the mean of the convolution and the predictive mean \(\hat{\lambda}_{k,t}\), we apply exponential tilting.
