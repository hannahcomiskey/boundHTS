...
The package has pre-defined convolution functions for Beta, zero-inflated Beta and zero-one inflated Beta distributions. These functions consider both point estimates and Monte-Carlo samples as inputs. ``
